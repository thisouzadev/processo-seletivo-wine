...
export declare function continueFromInitialStream(renderStream: ReactReadableStream, { suffix, dataStream, generateStaticHTML, flushEffectHandler, initialStylesheets, }: {
    suffix?: string;
